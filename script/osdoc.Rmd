...
```{r Figura7, fig.path='../fig/', fig.height=6, fig.width=6}
...
draw.quad.venn  (area1 = 299,
		 ...
		 n234 = 0,
		 n1234 = 0,
		 category = c('Cirurgia','Radioterapia','Quimioterapia','Terapia
			      alvo'),
		 fill = c('gray100','gray75','gray50','gray30'),
		 euler.d = T,
		 scaled = T)
```
